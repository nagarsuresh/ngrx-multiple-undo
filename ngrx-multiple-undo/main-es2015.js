...
let AppComponent = class AppComponent {
    constructor(store) {
        ...
        store.select(_reducers__WEBPACK_IMPORTED_MODULE_3__["hasUndo"]).subscribe(undoable => this.undoable = undoable);
    }
    ngOnInit() {
    }
    onAdd() {
        const order = { id: Object(shortid__WEBPACK_IMPORTED_MODULE_4__["generate"])(), customerName: `Customer ${Object(shortid__WEBPACK_IMPORTED_MODULE_4__["generate"])()}`, product: Object(shortid__WEBPACK_IMPORTED_MODULE_4__["generate"])(), rate: 2, total: 100 };
        this.store.dispatch(Object(_reducers__WEBPACK_IMPORTED_MODULE_3__["addOrder"])(order));
    }
    onDelete() {
        this.store.dispatch(Object(_reducers__WEBPACK_IMPORTED_MODULE_3__["deleteOrder"])({ ids: this.selected.map(s => s.id) }));
        this.selected = [];
    }
    onUndo() {
...
const addOrder = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])(`[Order] Add`, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const deleteOrder = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])(`[Order] Delete`, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const undo = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])(`[Order] Undo`);
const orderReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createReducer"])(INIT_ORDER_STATE, 
// add order
Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(addOrder, (state, order) => {
    const list = [...state.orders];
    list.push(order);
    return Object.assign({}, state, { orders: list });
}), 
// delete order
Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(deleteOrder, (state, { ids }) => {
...
function undoMetaReducer(reducer) {
    return (state = INIT_STATE, action) => {
        ...
        if (action.type === undo.type) {
            ...
            return Object.assign({}, state, { ordersState: replaceWith, undoStack: stack });
        }
        const undoStack = [...state.undoStack];
        undoStack.push(state.ordersState);
        state = Object.assign({}, state, { undoStack });
        return reducer(state, action);
    };
}
const metaReducers = !_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].production ? [undoMetaReducer] : [];
// SELECTORS
const hasUndo = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])((state) => state.undoStack, undoStack => undoStack && undoStack.length > 0);
